module.exports = function () {
    ...
    const adminteachercourses = require('./nodeFiles/adminFiles/adminteachercourses.js')
    const adminteacheraddcourse = require('./nodeFiles/adminFiles/adminteacheraddcourse.js')
    ...
    app.post('*/adminteachercourses', adminteachercourses.adminteachercoursesdetails)
    app.post('*/adminteacherdropcourse', adminteachercourses.adminteacherdropcourse)

    app.post('*/adminaddcourse', adminteacheraddcourse.adminaddcourse)
    app.post('*/adminaddcourseupload', adminteacheraddcourse.adminaddcourseupload)
    ...
    app.post('*/coursesregistered', admincoursesdetails.coursesregistered)
