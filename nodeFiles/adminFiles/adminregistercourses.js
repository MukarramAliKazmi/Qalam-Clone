...
function postregistercourses(req, res) {
    ...
    function ifteacherteaching(teacher) {
        ...
        con.query(`insert into student_courses (cmsid, courseid, classes_taken, omassignments, omquizes, omfinals, teacherid, grade) values(${req.body.cmsid}, ${req.body.courseid}, 0, 0, 0, 0, ${teacher}, null);`, function (err, result, fields) {
