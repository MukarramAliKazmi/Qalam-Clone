module.exports = function () {
    ...
    app.post('*/studentpreviousresultsdetails', studentresults.studentpreviousresultsdetails)

    app.get('*/studentregistercourses', studentregistercourses.studentregistercourses)

    app.post('*/studentregistercoursesupload', studentregistercourses.studentregistercoursesupload)
